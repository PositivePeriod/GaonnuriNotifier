...
boards = {'공지사항 게시판': 'board_notice', '임시 게시판': 'board_LoAj77', '규정 게시판': 'board_KbST22',
          ...
          '입시 정보 게시판': 'board_entrance', '수리 요청 게시판': 'board_repair', '연구회 게시판': 'board_research',
          '학년 교류 게시판': 'board_DPpO59', '학운위 공지사항': 'board_stunionreport', '학생회 건의 게시판': 'proposal'
          }
...
boards_info = {'공지사항 게시판': ('번호', '분류', '제목', '날짜', '조회수'),
               ...
               '연구회 게시판': ('번호', '제목', '글쓴이', '날짜', '마감기한', '조회수'),
               '학년 교류 게시판': ('번호', '제목', '글쓴이', '날짜', '조회수'),
               '학운위 공지사항': ('번호', '분류', '제목', '글쓴이', '날짜', '조회수'),
               '학생회 건의 게시판': ('번호', '분류', '제목', '글쓴이', '날짜', '조회수'),
               }

# 선거관리위원회, 홍보글 게시판,
# '학생회 말말말': ('번호', '분류', '제목', '날짜', '조회수'),
# '학생회 말말말': 'board_jMJE99',
boards_url = dict(zip(boards.keys(), [
                  f'{main_url}/index.php?mid={board}&page=' for board in boards.values()]))
